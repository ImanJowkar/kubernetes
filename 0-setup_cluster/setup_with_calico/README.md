...
```
kubeadm init  --apiserver-advertise-address 172.16.13.10 --pod-network-cidr 10.96.0.0/12
...
[apiclient] All control plane components are healthy after 14.001944 seconds
[upload-config] Storing the configuration used in ConfigMap "kubeadm-config" in the "kube-system" Namespace
[kubelet] Creating a ConfigMap "kubelet-config" in namespace kube-system with the configuration for the kubelets in the cluster
[upload-certs] Skipping phase. Please see --upload-certs
[mark-control-plane] Marking the node master as control-plane by adding the labels: [node-role.kubernetes.io/control-plane node.kubernetes.io/exclude-from-external-load-balancers]
[mark-control-plane] Marking the node master as control-plane by adding the taints [node-role.kubernetes.io/control-plane:NoSchedule]
[bootstrap-token] Using token: uq6avr.koz1b4ncdp88j4oh
...
### apply Calico CNI 
[refrenece](https://projectcalico.docs.tigera.io/getting-started/kubernetes/self-managed-onprem/onpremises)
```
...
# open the calico.yaml file and uncomment the below line 

vim calico.yaml
change the value of CIDR to CIDR which we setup the cluster
...
pod/calico-kube-controllers-798cc86c47-8z4nw   1/1     Running   0          10m
pod/calico-node-g8hbs                          1/1     Running   0          10m
pod/coredns-565d847f94-275sx                   1/1     Running   0          19m
pod/coredns-565d847f94-sgljw                   1/1     Running   0          19m
pod/etcd-master                                1/1     Running   0          19m
pod/kube-apiserver-master                      1/1     Running   0          19m
pod/kube-controller-manager-master             1/1     Running   0          19m
pod/kube-proxy-nx5sm                           1/1     Running   0          19m
pod/kube-scheduler-master                      1/1     Running   0          19m
...
NAME                                           READY   STATUS    RESTARTS      AGE
pod/calico-kube-controllers-798cc86c47-8z4nw   1/1     Running   1 (41m ago)   62m
pod/calico-node-g8hbs                          1/1     Running   0             62m
pod/calico-node-pnwb8                          1/1     Running   0             34m
pod/calico-node-qltc8                          1/1     Running   0             34m
pod/coredns-565d847f94-275sx                   1/1     Running   1 (41m ago)   72m
pod/coredns-565d847f94-sgljw                   1/1     Running   1 (41m ago)   72m
pod/etcd-master                                1/1     Running   0             72m
pod/kube-apiserver-master                      1/1     Running   0             72m
pod/kube-controller-manager-master             1/1     Running   0             72m
pod/kube-proxy-jn659                           1/1     Running   0             39m
pod/kube-proxy-nx5sm                           1/1     Running   0             72m
pod/kube-proxy-vz8j8                           1/1     Running   0             51m
pod/kube-scheduler-master                      1/1     Running   0             72m
...
master    Ready    control-plane   73m   v1.25.4
worker1   Ready    <none>          52m   v1.25.4
worker2   Ready    <none>          51m   v1.25.4
